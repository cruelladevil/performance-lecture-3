...
function MainPage(props) {
	const itemsImgRef = useRef(null);
	const partsImgRef = useRef(null);
	const stylesImgRef = useRef(null);
	...
	useEffect(() => {
		...
		observer.observe(itemsImgRef.current);
		observer.observe(partsImgRef.current);
		observer.observe(stylesImgRef.current);
				...
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_items} ref={itemsImgRef}/>
						</picture>,
						<Meta
							title={'Items'}
				...
				<TwoColumns
					...
					columns={[
						...
						<picture>
							...
							<img data-src={main_parts} ref={partsImgRef}/>
						</picture>
					]}
					mobileReverse={true}
				/>
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_styles} ref={stylesImgRef}/>
						</picture>,
						<Meta
							title={'Riding Styles'}
